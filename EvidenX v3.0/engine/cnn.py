    ...
    try:
        ...
        if 0.4 < score < 0.6:
            ...
            if laplacian_var < 100: # Blurry
                adjusted_score += 0.2 # Suspicious
            elif laplacian_var > 3000: # Noisy
                adjusted_score += 0.1
